...
var CSOCreator = (function () {
        ...
        ****************************************************************************************/
        ...
        var p_renderPage = function(req, res, composeResponse){
          res.render('createcso', { title: 'Create Composite Service Object', composeRes: composeResponse });
        }
        ...
        ****************************************************************************************/
        ...
        function deliverWebPage(req, res){
          p_renderPage(req, res, 'Create a Composite Service Object...');
        }
...
exports.create = function(req, res){
  if(req.params[0] == "create") {
    ...
    CompositeServiceObject.create(req, res, req.query.name, req.query.description, [req.query.soid1, req.query.soid2]);
